  ...
  return (
    <div className="text-sm">
      ...
      <div className="mt-2 px-1 pb-1">
        <p className="hidden last:block text-xs text-center text-muted-foreground pt-2">No documents found.</p>
